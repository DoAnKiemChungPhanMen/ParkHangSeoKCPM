...
var seeding_postgres = function (res) {
    pool_postgres.connect(function (error, connection, done) {
        async.series([
            ...
            function (callback) {
                connection.query(format('INSERT INTO users (first_name,last_name,email,phone,password,role_id) VALUES %L', user1), function (error, results, fields) {
                    if (error) {
                        callback(error);
                    } else {
                        callback();
            ...
            function (callback) {
                connection.query(format('INSERT INTO users (first_name,last_name,email,phone,password,role_id) VALUES %L', user2), function (error, results, fields) {
                    if (error) {
                        callback(error);
                    } else {
                        callback();
            ...
            function (callback) {
                connection.query(format('INSERT INTO users (first_name,last_name,email,phone,password,role_id) VALUES %L', user3), function (error, results, fields) {
                    if (error) {
                        callback(error);
                    } else {
                        callback();
            ...
            function (callback) {
                connection.query(format('INSERT INTO users (first_name,last_name,email,phone,password,role_id) VALUES %L', user4), function (error, results, fields) {
                    if (error) {
                        callback(error);
                    } else {
                        callback();
